...
const Login = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setLoading(false);
      toast.info("To enable real authentication, please connect Lovable Cloud.");
    }, 800);
  };

  const handleGoogleSignIn = () => {
    toast.info("To enable Google sign-in, please connect Lovable Cloud.");
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <Link to="/" className="flex items-center justify-center gap-2 mb-8 group">
          <div className="p-2.5 rounded-xl bg-gradient-sunset shadow-lg">
        ...
        <Card className="shadow-elevated border-border/50 backdrop-blur-sm">
          ...
          <CardContent className="space-y-5">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                type="submit"
                className="w-full h-11 bg-gradient-sunset hover:opacity-90 transition-opacity font-medium"
                disabled={loading}
              >
